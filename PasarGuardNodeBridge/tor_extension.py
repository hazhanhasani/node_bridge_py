...
async def grpc_enable_tor_location(self, location_id: str, timeout: int | None = None): return await _grpc_id_action(self, "EnableTorLocation", location_id, timeout)
async def grpc_disable_tor_location(self, location_id: str, timeout: int | None = None): return await _grpc_id_action(self, "DisableTorLocation", location_id, timeout)
async def grpc_restart_tor_location(self, location_id: str, timeout: int | None = None): return await _grpc_id_action(self, "RestartTorLocation", location_id, timeout)
async def grpc_new_tor_identity(self, location_id: str, timeout: int | None = None): return await _grpc_id_action(self, "NewTorIdentity", location_id, timeout)
async def grpc_get_tor_health(self, location_id: str, timeout: int | None = None): return await _grpc_id_action(self, "GetTorHealth", location_id, timeout)
async def grpc_repair_tor_location(self, location_id: str, timeout: int | None = None): return await _grpc_id_action(self, "RepairTorLocation", location_id, timeout)
async def grpc_test_tor_location(self, location_id: str, timeout: int | None = None): return await _grpc_id_action(self, "TestTorLocation", location_id, timeout)
...
async def _rest_call(self, method: str, endpoint: str, request, response_class, timeout: int | None = None):
    timeout = timeout or max(self._internal_timeout, 30)
...
async def rest_enable_tor_location(self, location_id: str, timeout: int | None = None): return await _rest_id_action(self, "tor/location/enable", location_id, timeout)
async def rest_disable_tor_location(self, location_id: str, timeout: int | None = None): return await _rest_id_action(self, "tor/location/disable", location_id, timeout)
async def rest_restart_tor_location(self, location_id: str, timeout: int | None = None): return await _rest_id_action(self, "tor/location/restart", location_id, timeout)
async def rest_new_tor_identity(self, location_id: str, timeout: int | None = None): return await _rest_id_action(self, "tor/location/new-identity", location_id, timeout)
async def rest_get_tor_health(self, location_id: str, timeout: int | None = None): return await _rest_id_action(self, "tor/location/health", location_id, timeout)
async def rest_repair_tor_location(self, location_id: str, timeout: int | None = None): return await _rest_id_action(self, "tor/location/repair", location_id, timeout)
async def rest_test_tor_location(self, location_id: str, timeout: int | None = None): return await _rest_id_action(self, "tor/location/test", location_id, timeout)
...
def install_tor_methods(grpc_node_cls, rest_node_cls) -> None:
    ...
    for name, fn in grpc_methods.items(): setattr(grpc_node_cls, name, fn)
    for name, fn in rest_methods.items(): setattr(rest_node_cls, name, fn)
